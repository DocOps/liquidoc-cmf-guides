include::{topic_page_meta}[tags="meta_adapt-these-docs"]
...
The files in this {project_name} repository also happen to be a customizable set of instructions for how to use _your actual LDCMF instance_.

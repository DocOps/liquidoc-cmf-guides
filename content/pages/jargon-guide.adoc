= Jargon Guide
:page-permalink: '{site_path}/jargon-guide'
...
include::{includes_dir}/_built_terms.adoc[]
...
This data is combined with the template at `_templates/liquid/terms.asciidoc` to build an AsciiDoc formatted file (`build/includes/_built_terms.adoc`).
****
